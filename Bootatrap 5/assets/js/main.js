(function ($) {
   ...
   if ($.fn.meanmenu) {
        $('nav#dropdown').meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='https://www.shodhyantri.com'><img src='https://www.shodhyantri.com/front/img/mobile-logo.png' alt='logo' class='img-fluid'/></a></div>"
        });
    }
